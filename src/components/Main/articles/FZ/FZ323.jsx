...
const FZ323 = () => {
  return (
    <div className="article">
      <h2 className="article__title">Федеральный закон от 21.11.2011 № 323-ФЗ <br />
         "Об основах охраны здоровья граждан в Российской Федерации"</h2>
      <>
      {/* <h3 className="article__glava"></h3>
      <h4 className="article__statya"></h4>
...
Статья 1. Предмет регулирования настоящего Федерального закона</h4>
...
<h4 className="article__statya">
Статья 2. Основные понятия, используемые в настоящем Федеральном законе</h4>
...
<h4 className="article__statya">
Статья 3. Законодательство в сфере охраны здоровья</h4>
...
(часть 5.1 введена Федеральным законом от 08.12.2020 N 429-ФЗ)
...
11. В соответствии с Федеральным законом от 31 июля 2020 года N 258-ФЗ "Об экспериментальных правовых режимах в сфере цифровых инноваций в Российской Федерации" в области законодательства в сфере охраны здоровья может быть установлено специальное регулирование, отличающееся от регулирования, предусмотренного положениями настоящего Федерального закона. Такое специальное регулирование устанавливается программой экспериментального правового режима в сфере цифровых инноваций, утвержденной Правительством Российской Федерации в соответствии с Федеральным законом от 31 июля 2020 года N 258-ФЗ "Об экспериментальных правовых режимах в сфере цифровых инноваций в Российской Федерации". Положения данной программы, устанавливающие условия экспериментального правового режима в сфере цифровых инноваций, могут изменять или исключать действие положений настоящего Федерального закона в случае, если это прямо предусмотрено настоящим Федеральным законом, и должны содержать в том числе перечень услуг, включая услуги, оказываемые с применением телемедицинских технологий, в отношении которых будет установлено специальное регулирование, а также вид ответственности, применяемой к субъектам экспериментального правового режима в сфере цифровых инноваций, с указанием условий ее наступления.
(часть 11 введена Федеральным законом от 02.07.2021 N 331-ФЗ)



<h3 className="article__glava">
Глава 2. ОСНОВНЫЕ ПРИНЦИПЫ ОХРАНЫ ЗДОРОВЬЯ</h3>

<h4 className="article__statya">
Статья 4. Основные принципы охраны здоровья</h4>
...
<h4 className="article__statya">
Статья 6. Приоритет интересов пациента при оказании медицинской помощи</h4>
...
<h4 className="article__statya">
Статья 7. Приоритет охраны здоровья детей</h4>
...
<h4 className="article__statya">
Статья 8. Социальная защищенность граждан в случае утраты здоровья</h4>
...
<h4 className="article__statya">
Статья 10. Доступность и качество медицинской помощи</h4>
...
<h4 className="article__statya">
Статья 11. Недопустимость отказа в оказании медицинской помощи</h4>
...
<h4 className="article__statya">
Статья 12. Приоритет профилактики в сфере охраны здоровья</h4>
...
<h4 className="article__statya">
Статья 13. Соблюдение врачебной тайны</h4>
...
САМОУПРАВЛЕНИЯ В СФЕРЕ ОХРАНЫ ЗДОРОВЬЯ</h3>

<h4 className="article__statya">
Статья 14. Полномочия федеральных органов государственной власти в сфере охраны здоровья</h4>

КонсультантПлюс: примечание.
В 2022 и 2023 годах Правительство РФ вправе принимать решения, предусматривающие особенности организации оказания медицинской помощи гражданам РФ, иностранным гражданам и лицам без гражданства (ФЗ от 26.03.2022 N 64-ФЗ).
...
(п. 15 в ред. Федерального закона от 30.04.2021 N 128-ФЗ)
...
(п. 21 введен Федеральным законом от 26.03.2022 N 64-ФЗ)
...
(п. 3.1 введен Федеральным законом от 30.04.2021 N 129-ФЗ)
...
(п. 19.1 введен Федеральным законом от 29.05.2019 N 119-ФЗ)
...
(п. 20 введен Федеральным законом от 21.07.2014 N 256-ФЗ; в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
...
(п. 21 введен Федеральным законом от 26.04.2016 N 112-ФЗ; в ред. Федеральных законов от 03.08.2018 N 299-ФЗ, от 27.12.2019 N 452-ФЗ)
...
(п. 4.1 введен Федеральным законом от 24.04.2020 N 147-ФЗ)
...
(п. 3 введен Федеральным законом от 05.04.2016 N 93-ФЗ; в ред. Федерального закона от 11.06.2021 N 170-ФЗ)
...
(п. 4 введен Федеральным законом от 05.04.2016 N 93-ФЗ; в ред. Федерального закона от 11.06.2021 N 170-ФЗ)
...
КонсультантПлюс: примечание.
Ч. 13 ст. 15 распространяется на полномочия федеральных органов исполнительной власти, которые не переданы для осуществления органам государственной власти субъектов РФ и органам местного самоуправления соответствующими федеральными законами.
...
(п. 18 введен Федеральным законом от 21.07.2014 N 256-ФЗ; в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
...
(п. 20 введен Федеральным законом от 29.12.2017 N 465-ФЗ)
...
(часть 3 введена Федеральным законом от 30.04.2021 N 129-ФЗ)

<h4 className="article__statya">
Статья 17. Полномочия органов местного самоуправления в сфере охраны здоровья</h4>
...
(в ред. Федерального закона от 26.05.2021 N 152-ФЗ)
...
<h4 className="article__statya">
Статья 18. Право на охрану здоровья</h4>
...
<h4 className="article__statya">
Статья 19. Право на медицинскую помощь</h4>
...
<h4 className="article__statya">
Статья 21. Выбор врача и медицинской организации</h4>
...
<h4 className="article__statya">
Статья 22. Информация о состоянии здоровья</h4>
...
<h4 className="article__statya">
Статья 23. Информация о факторах, влияющих на здоровье</h4>
...
<h4 className="article__statya">
Статья 24. Права работников, занятых на отдельных видах работ, на охрану здоровья</h4>
...
<h4 className="article__statya">
Статья 27. Обязанности граждан в сфере охраны здоровья</h4>
...
<h4 className="article__statya">
Статья 28. Общественные объединения по защите прав граждан в сфере охраны здоровья</h4>
...
<h3 className="article__glava">
Глава 5. ОРГАНИЗАЦИЯ ОХРАНЫ ЗДОРОВЬЯ</h3>

<h4 className="article__statya">
Статья 29. Организация охраны здоровья</h4>
...
<h4 className="article__statya">
Статья 30. Профилактика заболеваний и формирование здорового образа жизни</h4>
...
(часть 3.1 введена Федеральным законом от 11.06.2022 N 166-ФЗ)
...
<h4 className="article__statya">
Статья 32. Медицинская помощь</h4>
...
<h4 className="article__statya">
Статья 33. Первичная медико-санитарная помощь</h4>
...
<h4 className="article__statya">
Статья 34. Специализированная, в том числе высокотехнологичная, медицинская помощь</h4>
...
<h4 className="article__statya">
Статья 35. Скорая, в том числе скорая специализированная, медицинская помощь</h4>
...
<h4 className="article__statya">
Статья 36. Паллиативная медицинская помощь</h4>
...
<h4 className="article__statya">
Статья 36.1. Особенности медицинской помощи, оказываемой в рамках клинической апробации</h4>
...
<h4 className="article__statya">
Статья 37. Организация оказания медицинской помощи</h4>
...
(часть 1.1 введена Федеральным законом от 02.07.2021 N 315-ФЗ)
...
(часть 14.1 введена Федеральным законом от 30.12.2021 N 482-ФЗ)
...
<h4 className="article__statya">
Статья 38. Медицинские изделия</h4>
...
<h4 className="article__statya">
Статья 40. Медицинская реабилитация и санаторно-курортное лечение</h4>
...
<h4 className="article__statya">
Статья 41. Организация и оказание медицинской помощи при чрезвычайных ситуациях</h4>
...
<h4 className="article__statya">
Статья 42. Особенности организации оказания медицинской помощи отдельным категориям граждан</h4>
...
(часть 3 введена Федеральным законом от 22.10.2014 N 314-ФЗ)
...
3. Порядок организации медико-биологического обеспечения спортсменов спортивных сборных команд субъектов Российской Федерации утверждается органом государственной власти субъекта Российской Федерации в сфере здравоохранения по согласованию с органом государственной власти субъекта Российской Федерации в области физической культуры и спорта.
...
<h4 className="article__statya">
Статья 46. Медицинские осмотры, диспансеризация</h4>
...
<h4 className="article__statya">
Статья 47. Донорство органов и тканей человека и их трансплантация (пересадка)</h4>
...
КонсультантПлюс: примечание.
С 01.09.2022 ст. 47 дополняется чч. 17-18(ФЗ от 01.05.2022 N 129-ФЗ). См. будущую редакцию.

<h4 className="article__statya">
Статья 48. Врачебная комиссия и консилиум врачей</h4>
...
<h4 className="article__statya">
Статья 49. Медицинские отходы</h4>
...
(в ред. Федеральных законов от 25.11.2013 N 317-ФЗ, от 03.08.2018 N 323-ФЗ)
...
<h4 className="article__statya">
Статья 50. Народная медицина</h4>
...
СЕМЬИ И РЕПРОДУКТИВНОГО ЗДОРОВЬЯ</h3>

<h4 className="article__statya">
Статья 51. Права семьи в сфере охраны здоровья</h4>
...
КонсультантПлюс: примечание.
С 01.01.2023 ч. 3 ст. 51 излагается в новой редакции (ФЗ от 14.07.2022 N 317-ФЗ). См. будущую редакцию.
...
<h4 className="article__statya">
Статья 52. Права беременных женщин и матерей в сфере охраны здоровья</h4>
...
<h4 className="article__statya">
Статья 53.1. Федеральный реестр медицинских документов о рождении</h4>


1. В целях координации деятельности федеральных органов исполнительной власти, органов исполнительной власти субъектов Российской Федерации, органов местного самоуправления, медицинских организаций государственной, муниципальной и частной систем здравоохранения в части ведения учета сведений о рождении уполномоченным федеральным органом исполнительной власти осуществляется ведение в составе единой государственной информационной системы в сфере здравоохранения Федерального реестра медицинских документов о рождении (далее в настоящей статье - Федеральный реестр), содержащего документы о рождении, сформированные в форме электронного документа, а также сведения о рожденном ребенке и его матери, предусмотренные формой документа о рождении, утвержденной уполномоченным федеральным органом исполнительной власти.
...
<h4 className="article__statya">
Статья 54. Права несовершеннолетних в сфере охраны здоровья</h4>
...
(часть 4 введена Федеральным законом от 30.12.2021 N 482-ФЗ)
...
(часть 5 введена Федеральным законом от 30.12.2021 N 482-ФЗ)

<h4 className="article__statya">
Статья 55. Применение вспомогательных репродуктивных технологий</h4>
...
<h4 className="article__statya">
Статья 56. Искусственное прерывание беременности</h4>
...
<h4 className="article__statya">
Статья 57. Медицинская стерилизация</h4>
...
И МЕДИЦИНСКОЕ ОСВИДЕТЕЛЬСТВОВАНИЕ</h3>

<h4 className="article__statya">
Статья 58. Медицинская экспертиза</h4>
...
<h4 className="article__statya">
Статья 59. Экспертиза временной нетрудоспособности</h4>
...
(часть 2 в ред. Федерального закона от 30.04.2021 N 126-ФЗ)
...
(часть 3.1 введена Федеральным законом от 25.11.2013 N 317-ФЗ; в ред. Федерального закона от 30.04.2021 N 126-ФЗ)
...
(часть 3.2 в ред. Федерального закона от 30.04.2021 N 126-ФЗ)
...
<h4 className="article__statya">
Статья 60. Медико-социальная экспертиза</h4>
...
<h4 className="article__statya">
Статья 61. Военно-врачебная экспертиза</h4>
...
<h4 className="article__statya">
Статья 62. Судебно-медицинская и судебно-психиатрическая экспертизы</h4>
...
<h4 className="article__statya">
Статья 63. Экспертиза профессиональной пригодности и экспертиза связи заболевания с профессией</h4>
...
<h4 className="article__statya">
Статья 64. Экспертиза качества медицинской помощи</h4>
...
<h4 className="article__statya">
Статья 65. Медицинское освидетельствование</h4>
...
СО СМЕРТЬЮ ЧЕЛОВЕКА</h3>

<h4 className="article__statya">
Статья 66. Определение момента смерти человека и прекращения реанимационных мероприятий</h4>
...
<h4 className="article__statya">
Статья 67. Проведение патолого-анатомических вскрытий</h4>
...
<h4 className="article__statya">
Статья 68. Использование тела, органов и тканей умершего человека</h4>
...
<h4 className="article__statya">
Статья 68.1. Федеральный реестр медицинских документов о смерти</h4>
...
5. В случае наличия в государственных информационных системах сведений об умершем лице, формирование и (или) сбор которых осуществляются органами государственной власти Российской Федерации, органами управления государственными внебюджетными фондами в соответствии с их полномочиями, установленными федеральными законами, указанные сведения и (или) информация, позволяющая идентифицировать такие сведения в государственных информационных системах, представляются органами и организациями в Федеральный реестр в соответствии с порядком ведения указанного реестра.
...
РАБОТНИКИ, МЕДИЦИНСКИЕ ОРГАНИЗАЦИИ</h3>

<h4 className="article__statya">
Статья 69. Право на осуществление медицинской деятельности и фармацевтической деятельности</h4>
...
<h4 className="article__statya">
Статья 72. Права медицинских работников и фармацевтических работников и меры их стимулирования</h4>

КонсультантПлюс: примечание.
См. Перечень должностей подлежащих обязательному страхованию медицинских, фармацевтических и иных работников государственной и муниципальной систем здравоохранения, утв. Постановлением Правительства от 03.04.2006 N 191.
...
<h4 className="article__statya">
Статья 73. Обязанности медицинских работников и фармацевтических работников</h4>
...
(часть 1 в ред. Федерального закона от 25.12.2018 N 489-ФЗ)
...
(часть 6 введена Федеральным законом от 25.12.2018 N 489-ФЗ)
...
(часть 7 введена Федеральным законом от 25.12.2018 N 489-ФЗ)
...
(часть 8 введена Федеральным законом от 25.12.2018 N 489-ФЗ)
...
(в ред. Федеральных законов от 08.03.2015 N 55-ФЗ, от 29.12.2015 N 389-ФЗ, от 25.12.2018 N 489-ФЗ)
...
(п. 4 введен Федеральным законом от 29.12.2015 N 389-ФЗ)
...
(п. 5 введен Федеральным законом от 29.12.2017 N 465-ФЗ)
...
КонсультантПлюс: примечание.
С 01.09.2013 особенности реализации профессиональных образовательных программ медицинского и фармацевтического образования регулируются ст. 82 ФЗ от 29.12.2012 N 273-ФЗ.

<h4 className="article__statya">
Статья 77. Утратила силу с 1 сентября 2013 года.</h4>

<h4 className="article__statya">
Статья 78. Права медицинских организаций</h4>
...
(п. 3 в ред. Федерального закона от 29.07.2017 N 242-ФЗ)
...
(п. 3.1 введен Федеральным законом от 01.05.2017 N 86-ФЗ; в ред. Федерального закона от 30.04.2021 N 126-ФЗ)
...
(п. 5 в ред. Федерального закона от 29.07.2017 N 242-ФЗ)

<h4 className="article__statya">
Статья 79. Обязанности медицинских организаций</h4>
...
(в ред. Федеральных законов от 21.07.2014 N 256-ФЗ, от 05.12.2017 N 392-ФЗ)
...
(п. 9 в ред. Федерального закона от 22.12.2020 N 438-ФЗ)
...
КонсультантПлюс: примечание.
П. 11 - 12 ч. 1 ст. 79 признаны частично не соответствующими Конституции РФ (Постановление КС РФ от 13.07.2022 N 31-П).
...
(п. 14 введен Федеральным законом от 21.07.2014 N 256-ФЗ; в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
...
(п. 15 введен Федеральным законом от 29.05.2019 N 119-ФЗ)
...
(п. 16 введен Федеральным законом от 02.07.2021 N 313-ФЗ)
...
<h4 className="article__statya">
Статья 79.1. Независимая оценка качества условий оказания услуг медицинскими организациями</h4>
...
(в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
...
(часть 2 в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
...
(в ред. Федерального закона от 26.05.2021 N 152-ФЗ)
(часть 4 в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
...
(часть 6 в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
...
(часть 7 в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
...
(часть 8 в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
...
(п. 1 в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
...
(в ред. Федерального закона от 05.12.2017 N 392-ФЗ)
3) утратил силу. - Федеральный закон от 05.12.2017 N 392-ФЗ;
...
(часть 17 введена Федеральным законом от 05.12.2017 N 392-ФЗ)
...
(часть 18 введена Федеральным законом от 05.12.2017 N 392-ФЗ)



<h3 className="article__glava">
Глава 10. ПРОГРАММА ГОСУДАРСТВЕННЫХ ГАРАНТИЙ БЕСПЛАТНОГО
ОКАЗАНИЯ ГРАЖДАНАМ МЕДИЦИНСКОЙ ПОМОЩИ</h3>
...
КонсультантПлюс: примечание.
С 01.01.2023 п. 4 ч. 3 ст. 80 излагается в новой редакции (ФЗ от 14.07.2022 N 317-ФЗ). См. будущую редакцию.
...
КонсультантПлюс: примечание.
С 01.09.2022 в п. 7 ч. 3 ст. 80  вносятся изменения (ФЗ от 01.05.2022 N 129-ФЗ). См. будущую редакцию.
...
<h3 className="article__glava">
Глава 11. ФИНАНСОВОЕ ОБЕСПЕЧЕНИЕ В СФЕРЕ ОХРАНЫ ЗДОРОВЬЯ</h3>

<h4 className="article__statya">
Статья 82. Источники финансового обеспечения в сфере охраны здоровья</h4>
...
КонсультантПлюс: примечание.
С 01.09.2022 в абз. 1 ч. 9.1 ст. 83 вносятся изменения (ФЗ от 01.05.2022 N 129-ФЗ). См. будущую редакцию.
...
<h4 className="article__statya">
Статья 84. Оплата медицинских услуг</h4>
...
<h3 className="article__glava">
Глава 12. ОРГАНИЗАЦИЯ КОНТРОЛЯ В СФЕРЕ ОХРАНЫ ЗДОРОВЬЯ</h3>

<h4 className="article__statya">
Статья 85. Контроль (надзор) в сфере охраны здоровья</h4>
...
<h4 className="article__statya">
Статья 89. Ведомственный контроль качества и безопасности медицинской деятельности</h4>
...
<h4 className="article__statya">
Статья 90. Внутренний контроль качества и безопасности медицинской деятельности</h4>

Органами, организациями государственной, муниципальной и частной систем здравоохранения осуществляется внутренний контроль качества и безопасности медицинской деятельности в соответствии с требованиями к его организации и проведению, утвержденными уполномоченным федеральным органом исполнительной власти.
(в ред. Федерального закона от 25.12.2018 N 489-ФЗ)

<h4 className="article__statya">
Статья 91. Информационное обеспечение в сфере здравоохранения</h4>
(в ред. Федерального закона от 29.07.2017 N 242-ФЗ)
...
(в ред. Федерального закона от 22.12.2020 N 438-ФЗ)
...
<h4 className="article__statya">
Статья 91.1. Единая государственная информационная система в сфере здравоохранения</h4>
...
2) сведения о медицинских организациях, за исключением медицинских организаций, подведомственных федеральным органам исполнительной власти, в которых федеральными законами предусмотрена военная служба или приравненная к ней служба, а также медицинских организаций, подведомственных федеральным органам исполнительной власти, руководство деятельностью которых осуществляет Президент Российской Федерации;
(в ред. Федерального закона от 30.04.2021 N 128-ФЗ)
...
(п. 5.1 введен Федеральным законом от 02.07.2021 N 358-ФЗ)
...
(п. 6.1 введен Федеральным законом от 02.07.2021 N 358-ФЗ)
...
(п. 7.1 введен Федеральным законом от 22.12.2020 N 438-ФЗ)
...
4. Единая система обеспечивает ведение федеральных регистров, предусмотренных частью 2.1 статьи 43, частями 4 и 8 статьи 44, частью 1 статьи 44.1 настоящего Федерального закона и статьей 24.1 Закона Российской Федерации от 15 мая 1991 года N 1244-1 "О социальной защите граждан, подвергшихся воздействию радиации вследствие катастрофы на Чернобыльской АЭС", и федеральных реестров, предусмотренных частью 1 статьи 53.1 и частью 1 статьи 68.1 настоящего Федерального закона.
(часть 4 в ред. Федерального закона от 02.07.2021 N 358-ФЗ)
КонсультантПлюс: примечание.
Нормативные правовые акты, устанавливающие обязательные требования в соответствии с ч. 4.1 ст. 91.1, вступают в силу в сроки, установленные указанными актами (ФЗ от 02.07.2021 N 358-ФЗ).
...
(часть 4.1 введена Федеральным законом от 02.07.2021 N 358-ФЗ)
...
8) граждане.
(п. 8 введен Федеральным законом от 02.07.2021 N 358-ФЗ)
7. Утратил силу. - Федеральный закон от 02.07.2021 N 358-ФЗ.
...
(часть 9 введена Федеральным законом от 02.07.2021 N 358-ФЗ)
КонсультантПлюс: примечание.
Нумерация частей ст. 91.1 дана в соответствии с официальным текстом изменяющих документов.
9. Представление сведений, составляющих государственную тайну, для включения в единую систему не допускается.
(часть 9 введена Федеральным законом от 02.07.2021 N 312-ФЗ)

<h4 className="article__statya">
Статья 92. Ведение персонифицированного учета при осуществлении медицинской деятельности</h4>
...
(в ред. Федерального закона от 29.07.2017 N 242-ФЗ)
КонсультантПлюс: примечание.
О персонифицированном учете в сфере обязательного медицинского страхования см. ст. 43 ФЗ от 29.11.2010 N 326-ФЗ, Приказ Минздравсоцразвития РФ от 25.01.2011 N 29н.
...
<h4 className="article__statya">
Статья 93. Сведения о лицах, которые участвуют в осуществлении медицинской деятельности</h4>
(в ред. Федерального закона от 29.07.2017 N 242-ФЗ)
...
(в ред. Федеральных законов от 29.07.2017 N 242-ФЗ, от 02.07.2021 N 312-ФЗ)
...
(п. 22 в ред. Федерального закона от 25.12.2018 N 489-ФЗ)
...
<h4 className="article__statya">
Статья 96. Мониторинг безопасности медицинских изделий</h4>
...
<h4 className="article__statya">
Статья 97. Медицинская статистика</h4>
...
<h3 className="article__glava">
Глава 13. ОТВЕТСТВЕННОСТЬ В СФЕРЕ ОХРАНЫ ЗДОРОВЬЯ</h3>
<h4 className="article__statya">
Статья 98. Ответственность в сфере охраны здоровья</h4>
...
<h3 className="article__glava">
Глава 14. ЗАКЛЮЧИТЕЛЬНЫЕ ПОЛОЖЕНИЯ</h3>
<h4 className="article__statya">
...
<h4 className="article__statya">
Статья 100. Заключительные положения</h4>
...
(п. 1 в ред. Федерального закона от 02.07.2021 N 312-ФЗ)
КонсультантПлюс: примечание.
В 2022 году для осуществления медработниками фармацевтической деятельности в сельских населенных пунктах без аптек дополнительного профобразования в части розничной торговли лекарственными препаратами не требуется (Постановление Правительства РФ от 03.04.2020 N 440).
...
(в ред. Федерального закона от 02.07.2021 N 312-ФЗ)
...
КонсультантПлюс: примечание.
С 01.09.2017 ч. 4 ст. 100 не применяется (ч. 9 ст. 101 данного документа).
...
КонсультантПлюс: примечание.
С 01.09.2017 ч. 4.1 ст. 100 не применяется (ч. 9 ст. 101 данного документа).
...
(в ред. Федеральных законов от 28.12.2013 N 386-ФЗ, от 27.12.2019 N 478-ФЗ)
...
<h4 className="article__statya">
Статья 101. Порядок вступления в силу настоящего Федерального закона</h4>
...
4. Утратил силу. - Федеральный закон от 26.04.2016 N 112-ФЗ.
...
(часть 8.1 введена Федеральным законом от 01.12.2014 N 418-ФЗ; в ред. Федерального закона от 14.12.2015 N 374-ФЗ)
